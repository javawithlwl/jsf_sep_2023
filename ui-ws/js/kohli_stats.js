...
window.onload = function () {
    loadData().then(jsondata => {
        ...
        list_100_format = [["Format", "100s Count"]];
        ...
        document.getElementById("idCountry").addEventListener("change", function (event) {
...
function showCountry100Information(country, arr, format) {
    ...
    let table100Counts = `<table class="table table-bordered table-striped">
        <thead>
            <tr>
                <th>Format</th>
                <th>100s Count</th>

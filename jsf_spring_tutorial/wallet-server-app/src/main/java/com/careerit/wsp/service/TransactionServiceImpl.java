...
import com.careerit.wsp.repo.TransactionRepo;
...
public class TransactionServiceImpl implements TransactionService {
    ...
    public TransactionDto transferAmount(TransactionDto transactionDto) {
        ...
        Assert.notNull(transactionDto.getFromWalletId(), "From wallet id can't be null");
        Assert.notNull(transactionDto.getToWalletId(), "To wallet id can't be null");
